  ...
  (color-theme-install
   '(color-theme-6pi
     ((background-color . "#222222")
      ...
      (mouse-color . "sienna1"))
     (default ((t (:background "#222222" :foreground "#F8F8F8"))))
     (blue ((t (:foreground "blue"))))
     (bold ((t (:bold t))))
     (bold-italic ((t (:bold t))))
     (border-glyph ((t (nil))))
     (buffers-tab ((t (:background "#222222" :foreground "#F8F8F8"))))

     (font-lock-builtin-face ((t (:foreground "#F8F8F8"))))
     (font-lock-comment-face ((t (:italic t :foreground "grey"))))
     ...
     (font-lock-string-face ((t (:foreground "indian red")))) ;;string
     (font-lock-type-face ((t (:foreground "#8DA6CE"))))
     (font-lock-variable-name-face ((t (:foreground "#FF6400"))))
     (font-lock-warning-face ((t (:bold t :foreground "Pink"))))

     (minibuffer-prompt ((t (:foreground "cyan")))) ;;minibuffer-prompt (M-x)
...
(provide 'color-theme-6pi)       
;; Generated by JD Huntington using scpaste
